...
public class ProductFactory_Activity extends AppCompatActivity {
    ...
    private TextView position;      //地图上的位置
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView = (MapView)findViewById(R.id.product_bdmap_view);
        ...
        if(ContextCompat.checkSelfPermission(ProductFactory_Activity.this, Manifest.permission
        ...
        if(!permissionList.isEmpty()){
            ...
            ActivityCompat.requestPermissions(ProductFactory_Activity.this,permissions,1);
        }else{
            requestLocation();
        }
        ...
        baiduMap.setOnMapClickListener(new BaiduMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                Toast.makeText(ProductFactory_Activity.this, "经纬度("+
                        latLng.latitude+","+latLng.longitude+")", Toast.LENGTH_SHORT).show();
            }

            @Override
            public boolean onMapPoiClick(MapPoi mapPoi) {
                Toast.makeText(ProductFactory_Activity.this, "位置信息："+mapPoi.getName()
    ...
    public View.OnClickListener setFloatingButtonListener(final int id){
        View.OnClickListener onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(ProductFactory_Activity.this, "你点击的悬浮按钮的id 为： " + id, Toast.LENGTH_SHORT).show();
                //TODO
            }
        };
    ...
    public class MyLocationListener implements BDLocationListener{
        ...
        public void onReceiveLocation(BDLocation location){
            ...
            ProductFactory_Activity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    position = (TextView)findViewById(R.id.product_fac_position);
        ...
        public void onConnectHotSpotMessage(String s, int i) {
            switch(i){
                case LocationClient.CONNECT_HOT_SPOT_TRUE:
                    Toast.makeText(ProductFactory_Activity.this, "已连接WIFI", Toast.LENGTH_SHORT).show();
                    break;

                case LocationClient.CONNECT_HOT_SPOT_FALSE:
                    Toast.makeText(ProductFactory_Activity.this, "未连接WIFI", Toast.LENGTH_SHORT).show();
                    break;
                case LocationClient.CONNECT_HOT_SPOT_UNKNOWN:
                    Toast.makeText(ProductFactory_Activity.this, "连接WIFI状态未知", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    }
